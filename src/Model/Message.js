...
export default class Message extends Model{
                    ...
                    <div class="KYpDv">
                        <div>
                            <div class="_3v3PK" style="width: 330px; height: 330px;">
                                ...
                                <img src="${this.content.photo}" class="_1JVSX message-photo" style="width: 100%; display:none">
            ...
            case 'document':
                ...
                <div class="_3_7SH _1ZPgd">
                    <div class="_1fnMt _2CORf">
                        <a class="_1vKRe" href="#">
                            <div class="_2jTyA" style="background-image: url(${this.proview})"></div>
                            <div class="_12xX7">
                                <div class="_3eW69">
                        ...
                        <div class="_2jfIu">
                            <div class="_2cfqh">
                                <div class="_1QMEq _1kZiz fS1bA">
                                    ...
                                    <div class="_1_Gu6">
                                        <div class="message-audio-duration">00</div>
                                        <div class="_1sLSi">
    ...
    static sendAudio( chatId , from , file ,  metadata ,photo){
        ...
        return  Message.send(chatId , from , 'audio' , '' , false ).then(msgRef => {
            ...
            Message.upload(file , file ).then(snapshot => {
            ...
            return new Promise((s, f) => {
                Message.getRef(chatId).add({
                    ...
                    docRef.set({
                        ...
                        merge : true //se não fizer isso todos os dados  do usuario
                                    // serão apagados , e vai da um trabalho do cão recupera-las 
                    }).then(() => {
                        s(docRef);
                    })
                })
