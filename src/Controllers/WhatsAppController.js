...
export default class WhatsAppController {
    ...
    setActiveChat(contact){
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp').onSnapshot(docs => {
            ...
            docs.forEach(doc => {
                ...
                //se não existir outra messagem com o mesmo id faça
    ...
    elementsPrototype(){
        //importante usar funcao e nao erofunction pois vamos precisar usar o this.
        ...
        Element.prototype.toggle = function(){
            this.style.display = (this.style.display === 'nome')? 'block' : 'none'
            return this
        }
    ...
    initEvents(){
        ...
        this.el.myPhoto.on('click' , e => {
            //antes de abrir o  painel eu preciso da um open
        ...
        //keypress quando for preenchido
                ...
                if(data.name){
                    ...
                    Chat.createIfNotExists( this._user.email , contact.email ).then( chat => {
                        ...
                        this._user.addContact(contact).then(() => {
                            ...
                            console.log('Contato foi adcionado')
        ...
        this.el.inputDocument.on('change' , e=> {
            if(this.el.inputDocument.files.length){
                ...
                this._documentPreviewController.getPreviewData().then(result => {
                    ...
                    this.el.infoPanelDocumentPreview.innerHTML = result.src;
